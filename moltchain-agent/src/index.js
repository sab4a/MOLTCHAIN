...
program
  ...
  .option('--ai-provider <provider>', 'AI provider: ollama, openai, anthropic, groq, together')
  .option('--ai-api-key <key>', 'API key for AI provider')
  .option('--ai-model <model>', 'AI model name (e.g. llama2, gpt-4)')
  .option('--ai-endpoint <url>', 'Custom AI endpoint URL')
